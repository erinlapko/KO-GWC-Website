...
$query = "SELECT postid,title,poster,shortdesc from posts order by postid desc limit 0,5";
...
if (mysqli_num_rows($result) == 0){
   ...
   while($row=mysqli_fetch_array($result, MYSQL_ASSOC)){
       ...
       echo "<a href=\"index.php?content=post&id=$postid\">$title</a> submitted by <i>$poster</i><br>\n";
