<?php
$con = mysqli_connect("localhost", "test", "test") or  die('Sorry, could not connect to server');
...
if ($row[0] == 0) //if there're no comments
{
   echo "No comments posted yet.&nbsp;&nbsp;\n"; //&nbsp; means space
   echo "<a href=\"index.php?content=newcomment&id=$postid\">Add a comment</a>\n";
   echo "&nbsp;&nbsp;&nbsp;<a href=\"print.php?id=$postid\" target=\"_blank\">Print project</a>\n";
   echo "<hr>\n";
}
